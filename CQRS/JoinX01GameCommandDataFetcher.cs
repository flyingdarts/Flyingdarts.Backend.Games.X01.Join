...
public record JoinX01GameCommandDataFetcher(IDynamoDBContext DbContext, IOptions<ApplicationOptions> ApplicationOptions) : IRequestPreProcessor<JoinX01GameCommand>
{
